package com.example.apteki.ui.dashboard.employee.info
...
class EmployeeInfoAdapter : RecyclerView.Adapter<EmployeeInfoAdapter.ViewHolder>() {
    ...
    var tradeStatsList: List<MockData.BranchInfo>? = MockData.getBranchInfo()
    var onItemClick: ((MockData.BranchInfo) -> Unit)? = null
    ...
    inner class ViewHolder(var binding: ViewBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bindData(info: MockData.BranchInfo) {
            ...
            binding.branchNumberValue.text = info.branch
        }
